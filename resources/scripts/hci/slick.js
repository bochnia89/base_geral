    ...
    (s = 0),
        ((l = function (i, e) {
            ...
            (o.defaults = {
                ...
                asNavFor: null,
                prevArrow: '<button class="slick-prev" type="button"><span class="slick-prev-icon" aria-hidden="true"></span><span class="slick-sr-only">Anterior</span></button>',
                nextArrow: '<button class="slick-next" type="button"><span class="slick-next-icon" aria-hidden="true"></span><span class="slick-sr-only">Próximo</span></button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
                ...
                customPaging: function (i, e) {
                    return d('<button type="button"><span class="slick-dot-icon" aria-hidden="true"></span><span class="slick-sr-only">Ir para Imagem ' + (e + 1) + "</span></button>");
                },
                dots: !1,
